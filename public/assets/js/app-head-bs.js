...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Define the number of visits after which the modal should be shown again
    const resetVisits = 4;

    // Check if the modal needs to be shown based on visit count and previous display status
    if (!modalShown || visitCount >= resetVisits) {
        setTimeout(function() {

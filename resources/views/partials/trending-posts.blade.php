                        ...
                        <div class="block-layout grid-layout vstack gap-2 xl:gap-3 panel overflow-hidden">
                            <div class="block-header panel hstack justify-between px-2 py-1 bg-gray-800 text-white uc-dark">
                                ...
                                <ul class="nav-x gap-narrow">
                                    <li><a href="#tw" class="w-24px h-24px cstack rounded-circle hover:bg-primary hover:text-dark"><i class="icon icon-1 unicon-logo-x-filled"></i></a></li>
                                    <li><a href="#in" class="w-24px h-24px cstack rounded-circle hover:bg-primary hover:text-dark"><i class="icon icon-1 unicon-logo-instagram"></i></a></li>
                                </ul>
                            </div>
                            <div class="block-content">
